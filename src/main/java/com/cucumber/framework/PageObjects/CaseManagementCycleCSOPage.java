...
public class CaseManagementCycleCSOPage extends SeleniumFunc
	...
	public String LoginToUserAndGetTheSum(String productCode, String sub) throws Exception {
		if (productCode.equalsIgnoreCase("ISR") || productCode.equalsIgnoreCase("ISC")
			...
			int sum1 = LoginAndGetSumOfUserOne("ISRUser_1", "OF@12345");
			int sum2 = LoginAndGetSumOfUserTwo("ISRUser_2", "OF@12345");
			...
			int sum2 = LoginAndGetSumOfUserTwo("PADUser_2", "OF@12345");
		...
		else if (productCode.equalsIgnoreCase("MPA") || productCode.equalsIgnoreCase("HPK")) 
		{
			int sum1 = LoginAndGetSumOfUserOne("HPKMPAUser_1", "OF@123456");
			int sum2 = LoginAndGetSumOfUserTwo("HPKMPAUser_2", "OF@123456");
